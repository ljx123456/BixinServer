...
public class CameraSdkParameterInfo implements Serializable {
    ...
    public static final int TAILOR_PICTURE_FROM_CAMERA = 500;
    ...
    public static final int TAKE_VIDEO_FROM_CAMERA = 600;
    public static final int TAKE_VIDEO = 700;
    ...
    //是否显示裁剪尺寸匡
    private boolean showTailor = false;
    ...
    public boolean isShowTailor() {
        return showTailor;
    }

    public void setShowTailor(boolean showTailor) {
        this.showTailor = showTailor;
    }
