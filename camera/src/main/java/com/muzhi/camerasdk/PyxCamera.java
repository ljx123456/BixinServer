...
////            if (fragment!=null){
////                contentResolver =(fragment.getActivity()).getContentResolver();//cutPic.this是一个上下文
////            }
//            contentResolver = activity.getContentResolver();//cutPic.this是一个上下文
////            val url =  MediaStore.Images.Media.DATA + "='" + path + "'"
////            //删除图片
////            contentResolver.delete(uri, url, null)
//            String url =  MediaStore.Images.Media.DATA + "=?";
//            //删除图片
//            contentResolver.delete(uri, url, new String[]{path});
//        }
        if(!TextUtils.isEmpty(path)){
            Uri uri = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
            Log.e("测试","删除照片 ");
