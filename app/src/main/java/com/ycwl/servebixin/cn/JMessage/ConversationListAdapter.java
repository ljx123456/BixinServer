package com.ycwl.servebixin.cn.JMessage;
...
//                            Log.e("测试删除",((UserInfo) convItem.getTargetInfo()).getAppKey()+"4b24613280bd2c477bab4989");
                            if (JMessageClient.deleteSingleConversation(((UserInfo) convItem.getTargetInfo()).getUserName(),((UserInfo) convItem.getTargetInfo()).getAppKey())){
//                                Log.e("测试","删除成功");
                                Toast.INSTANCE.Tips("删除成功");
