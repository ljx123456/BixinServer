package com.ycwl.servebixin.cn.view.tag;
...
public class MultiLineChooseLayout extends ViewGroup {
    ...
    public MultiLineChooseLayout(Context context, AttributeSet attrs/*, int defStyleAttr*/) {
        ...
        try {
            ...
            multiChooseable = attrsArray.getBoolean(R.styleable.MultiLineChooseItemTags_item_multiChooseable, false);
            ...
            float radius = attrsArray.getDimension(R.styleable.MultiLineChooseItemTags_item_radius, 14);
...
//            Toast.INSTANCE.Tips("点击");
            //如果可以点击的话
            if (item_click) {
//                Toast.INSTANCE.Tips("点击2");
                ...
                if (!multiChooseable) {
                    ...
                    //多选
                    if (getAllItemSelectedTextWithListArray().size() >12) {
                        Toast.INSTANCE.Tips("最多选择12个职业标签");
                        if (tag.isChecked) {
