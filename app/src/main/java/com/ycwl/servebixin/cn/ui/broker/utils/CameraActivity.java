package com.ycwl.servebixin.cn.ui.broker.utils;
...
//                mIvCameraCrop.setImageResource(R.mipmap.camera_back);
                mIvCameraCrop.setImageResource(R.mipmap.camera_idcard_front);
                break;
            case TYPE_IDCARD_BACK:
//                mIvCameraCrop.setImageResource(R.mipmap.camera_positive);
