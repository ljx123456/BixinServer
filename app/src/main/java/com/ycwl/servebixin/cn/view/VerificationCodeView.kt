package com.ycwl.servebixin.cn.view
...
class VerificationCodeView : LinearLayout, TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    private fun initEditText(editText: EditText, i: Int) {
        ...
        when (mEtInputType) {
            ...
            VCInputType.NUMBERPASSWORD -> editText.inputType = InputType.TYPE_NUMBER_VARIATION_PASSWORD
