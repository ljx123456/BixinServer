package com.ycwl.servebixin.cn.jpush
...
import com.ycwl.servebixin.cn.db.user.getUserID
import com.ycwl.servebixin.cn.ui.main.activity.MainActivity
    ...
    fun setTag(context: Context) {
        ...
        if (user != null) {
            ...
            if (data != null && data.size >= 1 && data.get(0).token != null) {
                ...
                JPushInterface.setAlias(context, getUserID()) { i, s, set ->
                    if (i == 0) {
                        Log.d("123456", "成功")
                    } else if (i == 6002) {
                        setTag(context)
...
//            }
    ...
    private fun createNotificationChannel(context: Context) {
        val channel = NotificationChannel("123456", "比心娱乐", NotificationManager.IMPORTANCE_DEFAULT)
