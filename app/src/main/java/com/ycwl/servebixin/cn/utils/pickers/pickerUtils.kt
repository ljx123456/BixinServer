package com.pp.wsy.bosom.app.utils.pickers
...
object pickerUtils {
    ...
    fun showPicker(picker: DatePicker) {
        ...
        picker.setDividerRatio(WheelView.DividerConfig.WRAP)
        picker.setOffset(3)
        picker.setSubmitTextColor(Color.parseColor("#666666"))
        picker.setSubmitTextSize(16)
        ...
        picker.setTextColor(Color.parseColor("#FF6464"))
    ...
    fun showMonthPicker(picker: DatePicker) {
        picker.setCanceledOnTouchOutside(true)
        picker.setDividerRatio(WheelView.DividerConfig.WRAP)
        picker.setOffset(3)
        picker.setSubmitTextColor(Color.parseColor("#666666"))
